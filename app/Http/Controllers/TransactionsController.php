    ...
    public function index(Request $request)
{
    ...
    $transactions = Transactions::with('detail.product', 'user')
...
{
    $filter = $request->input('filter_by', 'month');

    return Excel::download(new TransactionExport($filter), 'Transaksi.xlsx');
}
